...
const Contact = () => {
  ...
  return (
    <div className="bg-[#272c35] bg-cover bg-center">
      <Particle />
      <div className="h-[100%] pb-[4rem]">
        ...
        <div className="pt-[5rem] pb-[4rem] w-[80%] mx-auto flex flex-col md:flex-row">
          <div className="mb-8 max-w-[40rem]">
            ...
            <p className="text-white font-normal w-[80%] text-[17px] text-left bg-[#0f1722] p-4 rounded-lg shadow-md shadow-[#55e6a5] mb-10">
              Say hello to{" "}
              <span className="text-[#55e6a5]">juniordeungou@gmail.com</span>{" "}
              For more information. Contact me with any questions, collaboration
              opportunities or just to exchange ideas. I'm always available to
              discuss exciting projects and explore new opportunities. Fill in
              the form below or use the contact details provided to get in touch
              with me directly. I look forward to hearing from you!
            </p>
            <div className="flex flex-row text-[#55e6a5] gap-4 mb-10">
              ...
              />
              <SocialIcon
                url={socialMediaHandlesLinks.linkedin}
                bgColor="#24292e"
              />
              <SocialIcon
                url={socialMediaHandlesLinks.instagram}
                bgColor="#24292e"
              />
              <SocialIcon
                url={socialMediaHandlesLinks.twitter}
                bgColor="#24292e"
              />
            </div>
            <DownloadCv />
